####################################################################################################
# CWBND_3diffsize: Circular weakly balance neighbour design for block of three different sizes 
# (K1,k2 and k3)
...
# D=1: Minimal CWBNDs in which v/2 of the ordered pairs appear twice as neighbors
# D=2: Minimal CWBNDs in which 3v/2 of the unordered pairs appear twice as neighbors 
...
# Example#1
(H<-CPBND_3diffsize(k=c(12,7,4),i=5,D=1,sk2=1,sk3=1))
(design_CWBND(H))

#Example#2
(H<-CPBND_3diffsize(k=c(8,5,4),i=6,D=2,sk2=1,sk3=1))
(design_CWBND(H))

#Example#3
(H<-CPBND_3diffsize(k=c(11,8,4),i=5,D=1,sk2=2,sk3=2))
(design_CWBND(H))

#Example#4
(H<-CPBND_3diffsize(k=c(9,7,6),i=3,D=2,sk2=2,sk3=2))
(design_CWBND(H))

#Example#5
(H<-CPBND_3diffsize(k=c(8,6,4),i=5,D=2,sk2=1,sk3=2))
(design_CWBND(H))

#Example#6
(H<-CPBND_3diffsize(k=c(14,7,4),i=6,D=2,sk2=2,sk3=1))
(design_CWBND(H))
